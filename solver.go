...
const (
	isFreeDrainage = true
	isInfiltrating = true // set to false to activate evaporation
	...
	mw   = .01802 // molecular weigh of water [kg/mol]
	eta  = .66    // Penman (1940)
	// kap  = .4     // von-Karman constant
	...
	// ep = 0.21 / 3600. // potential evaporation rate [mm/s]
)
